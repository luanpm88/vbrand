  ...
  <!--Chuyên mục-->
    <div class="col-lg-6">       
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="currency" value="{{ old('currency') ??  'USD' }}">
      </div>
    </div> <!-- end col -->
    <div class="col-lg-6">       
      <div class="form-group">
      ...
      <div class="form-group">
          ...
          <input type="text" class="form-control" name="saleoff" value="{{ old('saleoff') ?? '' }}">
      </div> 
    </div> <!-- end col -->
</div> <!-- end row -->
...
<div class="row">
  <div class="col-lg-12"> 
    <div class="form-group">
      ...
      <textarea name="content" id="contents" class="form-control" maxlength="225" rows="10">{{ old('content') ?? '' }}</textarea>
