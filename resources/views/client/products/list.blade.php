...
<div class="mb-3 mt-3">
    <h5 class="mt-0 mb-0 me-auto">Tất cả sản phẩm</h5>
    ...
    <tbody>
        @foreach ($products as $product)
            <tr>
                ...
                <td>10</td>
                <td>
                    <span class="badge bg-secondary">Mới nhập</span>
                    @if ($product->lazada_id)
                        <br><span class="badge bg-warning" style="background:#e5702c!important">Lazada</span>
                    @endif
                </td>
                <td>{{ $product->created_at->diffForHumans() }}</td>
                <td>
                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                        <button type="button" class="btn btn-outline-secondary px-2 py-0 text-nowrap">
                            <i class="material-icons-outlined">edit</i> Sửa
                        </button>
                      
                        <div class="btn-group" role="group">
                          <button id="btnGroupDrop1" type="button" class="btn btn-outline-secondary dropdown-toggle px-2 py-0 ps-1" data-bs-toggle="dropdown" aria-expanded="false">
                          </button>
                          <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                <li><a class="dropdown-item" href="#">Kiểm tra kho</a></li>
                                <li><a class="dropdown-item" href="#">In mã vạch</a></li>
                                <li><a class="dropdown-item text-danger" href="#">Xoá sản phẩm</a></li>
                          </ul>
                        </div>
                      </div>
                </td>
