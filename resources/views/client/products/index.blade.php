...
@section('content')
    ...
    <h2>Liên kết sàn TMĐT</h2>
    <div class="sendo-introduce-text fw-bold mb-1">Chúng tôi giúp bạn:</div>
    <div class="sendo-introduce-help d-flex mb-1"><div class="sendo-introduce-help-icon me-2"><svg width="19" height="12" viewBox="0 0 19 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 6.5L7.5 12L17.5 2" stroke="#0089FF" stroke-width="3" stroke-linecap="round"></path></svg></div><div class="sendo-introduce-text">Kết nối cùng lúc nhiều gian hàng trên Sapo giúp quản lý đồng bộ, xuyên suốt</div></div>
    <div class="sendo-introduce-help d-flex mb-1"><div class="sendo-introduce-help-icon me-2"><svg width="19" height="12" viewBox="0 0 19 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 6.5L7.5 12L17.5 2" stroke="#0089FF" stroke-width="3" stroke-linecap="round"></path></svg></div><div class="sendo-introduce-text">Đồng bộ sản phẩm giữa Sapo và sàn TMĐT giúp kiểm soát tồn kho, tiết kiệm thời gian cập nhật thông tin giá cả</div></div>
    <div class="sendo-introduce-help d-flex mb-3"><div class="sendo-introduce-help-icon me-2"><svg width="19" height="12" viewBox="0 0 19 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 6.5L7.5 12L17.5 2" stroke="#0089FF" stroke-width="3" stroke-linecap="round"></path></svg></div><div class="sendo-introduce-text">Đồng bộ gian hàng từ sàn TMĐT về Sapo giúp giảm tải nguồn lực quản lý cửa hàng</div></div>
    <div class="mb-4">
                ...
                <div class="mr-auto">
                    <div class="btn-group" role="group">
                        <button id="btnGroupDrop1" type="button" class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            <span class="float-start">
                                <span class="d-flex align-items-center">
                                    <i class="material-icons-outlined me-1">sync</i>
                        ...
                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                            @if ($lazadaConnection->connected())
                                <li>
                                    <a class="dropdown-item lazada-sync" href="{{ action('Client\ConnectionController@lazadaSync') }}">
                                        Đồng bộ sản phẩm từ <strong>Lazada</strong>
                                    </a>
                                </li>
                            @else
                                <li>
                                    <a class="dropdown-item" href="{{ $lazadaConnectLink }}">
                                        Kết nối với sàn TMĐT <strong>Lazada</strong>
                                    </a>
                                </li>
                            @endif
                            
                            <li><a class="dropdown-item" href="#">Kết nối với sàn TMĐT <strong>Shopee</strong></a></li>
                        </ul>
                    </div>
    ...
    <script>
        var lazadaSync = new Popup();

        $('.lazada-sync').on('click', function(e) {
            e.preventDefault();
